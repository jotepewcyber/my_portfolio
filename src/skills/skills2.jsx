...
function Skills() {
    ...
    const commands = [
        { cmd: 'cd my_skills_development', out: null },
        { cmd: 'ls -la', out: ['rwx HTML','rwx CSS/TAILWIND','rwx JAVASCRIPT','rwx REACT','rwx SPRINGBOOT','rwx REST_APIs','rwx JWT/Authentication'] },
