...
import cryptography from '../images/crypto.png'
import burpsuite from '../images/burp.png'
...
function Skills() {
    ...
    const commands = [
        { cmd: 'cd cyberSecurity', out: null },
        { cmd: 'ls -la', out: ['rwx CEH(v13)','rwx LINUX_ADMINISTRATION','-wx OWASP_TOP_10','--x PENTETRATION_TESTING','rwx WEB_SECURITY','r-x CRYPTOGRAPHY','--x METASPLOIT','--x BURPSUITE'] },
    ...
    <div className="container flex flex-wrap px-5 py-24 mx-auto items-center">
        ...
        <nav className='flex flex-wrap list-none -mb-1'>
            ...
            <img src={linux} alt="php" className='rounded-full w-24 h-24 object-cover'/></li>

            <li className='lg:w-1/3 mb-4 w-1/2'>
            <img src={ceh} alt="html" className='rounded-full w-24 h-24 object-cover'/></li>

            <li className='lg:w-1/3 mb-4 w-1/2'>
            <img src={cryptography} alt="css" className='rounded-full w-24 h-24 object-cover'/></li>

            <li className='lg:w-1/3 mb-4 w-1/2'>
            <img src={burpsuite} alt="javascript" className='rounded-full w-24 h-24 object-cover'/></li>

            <li className='lg:w-1/3 mb-4 w-1/2'>
            <img src={metasploit} alt="linux" className='rounded-full w-24 h-24 object-cover'/></li>
